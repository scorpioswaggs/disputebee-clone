        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl mb-8 max-w-3xl mx-auto">
              Have questions or need assistance? We're here to help you on your credit repair journey.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <form>
                ...
                <button
                  type="submit"
                  className="bg-blue-800 hover:bg-blue-700 text-white font-medium py-3 px-6 rounded-md transition duration-300"
                >
                  Send Message
                </button>
              </form>
            ...
            <div>
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div className="ml-3">
                    ...
                    <p className="mt-1 text-gray-600">support@credisure.com</p>
                    <p className="mt-1 text-gray-600">For general inquiries: info@credisure.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-3">
                    ...
                    <p className="mt-1 text-gray-600">Customer Support: (800) 123-4567</p>
                    <p className="mt-1 text-gray-600">Hours: Monday-Friday, 9am-5pm EST</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-3">
                    ...
                    <p className="mt-1 text-gray-600">123 Credit Repair Street</p>
              ...
              <div className="mt-8 p-6 bg-gray-50 rounded-lg">
                ...
                <p className="text-gray-600 mb-4">
                  Find answers to common questions about our services, pricing, and credit repair process.
                </p>
                <Link 
                  href="/faq" 
